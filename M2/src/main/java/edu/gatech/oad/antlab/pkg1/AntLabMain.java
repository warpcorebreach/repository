 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Justin Coates");
		  toPrint += p1.toString("jcoates8");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("JD Arthur");
		  toPrint += p2.toString("jarthur7");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Weiyu Li");
		  toPrint += p3.toString("wli99");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Qifeng Li");
                  toPrint += p4.toString("qli68");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Duc Tran");
                  toPrint += p5.toString("dtran39");
